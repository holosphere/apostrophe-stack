      ...
      <div data-element class="apos-template apos-array-item">
        <div class="apos-ui-container right">
          <span class="apos-ui-btn-group">
            <!-- <a href="#" class="apos-ui apos-ui-btn apos-array-move" data-move><i class="fa fa-move"></i></a> -->
            ...
            #}<a href="#" class="apos-ui apos-ui-btn apos-array-remove" data-remove><i class="fa fa-remove"></i></a>
          </span>
        </div>
        {{ schemaFields(schema) }}
      </div>
