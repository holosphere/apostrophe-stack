...
site.init({
  ...
  afterInit: function(callback) {
    ...
    if(locals.development || !locals.minify) {
      console.error('Apostrophe is running in development mode.');
    } else {
      console.error('Apostrophe is running in production mode.');
    }
